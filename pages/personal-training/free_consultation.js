    ...
    return (
        <div>
                ...
                <li className="flex flex-col justify-center items-center text-center bg-white shadow-lg p-4">
                    ...
                    <span className="">Discover what motivates you—what is your “why”?</span></li>
                <li>Establish your fitness level by learning a few fundamental movement patterns</li>
                <li>Receive expert fitness recommendations and establish a plan</li>
