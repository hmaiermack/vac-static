    ...
    return (
        ...
        <div className="h-screen flex">
            ...
            <h1 className="tracking-tight mt-52 nav2:mt-44 med:mt-0 sm:text-center text-left">
              <span className="block text-yellow-400 font-extrabold uppercase tracking-tighter text-6xl sm:text-7xl med:text-8xl leading-none mb-8 md:mb-0">Reach your goals</span>
